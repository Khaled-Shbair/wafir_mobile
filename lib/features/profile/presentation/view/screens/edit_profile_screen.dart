    ...
    return Scaffold(
      ...
      body: BlocConsumer<EditProfileBloc, EditProfileState>(
        listener: (context, state) {
          if (state.status == EditProfileStatus.failure && state.message != null) {
            ScaffoldMessenger.of(context)
              ..clearSnackBars()
              ..showSnackBar(SnackBar(content: Text(state.message!)));
          }
          if (state.status == EditProfileStatus.success && state.message != null) {
            ScaffoldMessenger.of(context)
              ..clearSnackBars()
              ..showSnackBar(SnackBar(content: Text(state.message!)));
          }
        ...
        builder: (context, state) {
          if (!state.isProfileLoaded &&
              state.status == EditProfileStatus.loadingProfile) {
                  ...
                  children: [
                    Stack(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: canSubmit ? () => controller.add(ChangeImage()) : null,
                          child: CircleAvatar(
